...
#alias win8='8c:89:a5:e4:bd:d1'

#PS1='[\u@\h \W]\$ '
PATH=/home/taylor/bin:$PATH:/opt/java6/bin:$(ruby -rubygems -e "puts Gem.user_dir")/bin
export PATH
...
## source adb bash-completion
if [ -f /usr/share/bash-completion/completions/adb ]; then
...
sensors() { if [[ $@ == "cpu" ]]; then command sensors coretemp-isa-0000; else command sensors "$@"; fi; }
